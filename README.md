...
> *   С 2009 года изучал Базу Данных Cache Intersystems. Имел сертификат разработчика. Одновременно с этим активно работал на html, SVG графиках любой сложности.
